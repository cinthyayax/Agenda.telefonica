<script type="text/javascript">
	...
	function sndBuscar() 
	{
		http.open('get', 'back_busca_tipotelefono.php?nombre_filtro='+document.formulario.ingreso_buscar.value);
...
<h1>Cat&aacutelogo: Tipo de tel&eacute;fono</h1>

<form name="formulario" id="formulario" method="post" action="back_crea_tipotelefono.php">
