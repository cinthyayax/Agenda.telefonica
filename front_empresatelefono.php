<script type="text/javascript">
	...
	function sndBuscar() 
	{
		http.open('get', 'back_busca_empresatelefono.php?nombre_filtro='+document.formulario.ingreso_buscar.value);
	...
	function validar()
	{
		A = vacio(document.formulario.des_empresa.value);
...
<h1>Cat&aacutelogo: Tipo Empresa tel&eacute;fono</h1>

<form name="formulario" id="formulario" method="post" action="back_crea_empresatelefono.php">
	<table border="0" style="background:#FFFFCC">
    	<tr>        	
            <th width="150">Descripci&oacute;n:</th>
            <td width="250"><input type="text" maxlength="75" name="des_empresa" id="des_empresa" style="width:350px"></td>            
        </tr>
		<tr>
